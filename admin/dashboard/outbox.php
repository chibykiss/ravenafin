...
<div class="row">
	...
	<div class="well" style="margin-bottom: 20px; color: black;">
  		...
  		<div class="form-group">
    		<textarea class="form-control" style="padding-left: 0px;" name="bio" id="bio">
    			Message content
    		</textarea>
  		</div>
  
     <button type="submit" name="out" class="btn btn-info">SENT</button>
	</form>
 <?php $classObj->pullad(); ?>
 		<div class="well" style="color: black;">
      From : soloski<br>
      To : sadfggd <br>
      Date : 2018-04-12 20:05:15<br>
      <br><br>
      rr
    </div>
  <br> <br>
