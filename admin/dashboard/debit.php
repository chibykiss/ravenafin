...
<h3 class="text-center" style="color:black;">Account balance $<?php echo $classObj->pullbal(); ?> <br>

</h3>

<div class="row">
	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"></div>
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 well" style="padding: 30px; color: green;">
		
<form method="post">
	<?php $classObj->dedituser(); ?>
  <div class="form-group">
    <input type="text" name="amount" class="form-control" placeholder="Amount" pattern="^([1-9][0-9]{0,9}|1000000)$" required="" />
  </div>
  
  <button type="submit" name="cc" class="btn btn-default">debit</button>
</form>
