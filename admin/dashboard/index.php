  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" style="color:  #fbf5f7;">
		...
		<li style="color: #fbf5f7; font-size:20px;"><a href="../../users/sign_up.php">Add User</a></li>
...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding: 20px;">
		<div class="well quill" style=" text-align: center;">
			<span class="fa fa-hand-paper-o vom"> 
			</span>

			<h3 style="color: #8C6673;"> Members</h3>
			<h3 style="color: #8C6673;"> <a href="transaction.php"> Transtion </a></h3>
		</div>
	...
	<div class="well quill" style=" text-align: center;">
			...
			<h3 style="color: #8C6673;"> Messages</h3>
			<h3 style="color: #8C6673;"> <a href="tac.php"> TAC  </a> </h3>
		</div>	
	</div>
</div>
