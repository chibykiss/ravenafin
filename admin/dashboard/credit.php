...
<form method="post">
	<?php $classObj->credituser(); ?>
  <div class="form-group">
    <input type="text" name="amount" class="form-control" placeholder="Amount" pattern="^([1-9][0-9]{0,9}|100000)$" required="" />
  </div>
  
  <button type="submit" name="cc" class="btn btn-default">credit</button>
</form>
