...
<div class="form-group">
	<img src="upload/<?php $classObj->postimgview(); ?>" style="height: 100px; width: 100px;" /><br><br>
    <input type="file" class="form-control" name="img" placeholder="image" required=""/ >
  </div>
  <?php $classObj->editimgp(); ?>

  <?php $classObj->editstuff(); ?>
<button type="submit" name="upload" class="btn btn-info">Add post</button>
</form> 
...
<form method="POST" enctype="multipart/form-data">
  ...
  <?php $classObj->postext(); ?>

  <button type="submit" name="up" class="btn btn-info">Edit post</button>
