...
<div class="row">
	...
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding: 30px;">
		<div class="well" style="margin-bottom: 20px; color: black;">
		
	<form  method="POST">
 	<?php $classObj->resetpassad(); ?>
  		<div class="form-group">
  		<input type="password" class="form-control" name ="oldpass" placeholder="Enter old password "  required=""></input>
  		</div>
  
  		<div class="form-group">
  		<input type="password" class="form-control" name ="newpass" placeholder="Enter new password " required=""></input>
  		</div>
  		5361028194
  		<div class="form-group">
  		<input type="password" class="form-control" name ="newpass1" placeholder="Confirm new password " required=""></input>
  		</div>
  	
     <button type="submit" name="reset" class="btn btn-info">SENT</button>
	</form>
