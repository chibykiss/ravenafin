...
<h3 class="text-center" style="color:black;">Present date <?php $classObj->getid(); ?> <br>
...
<form method="post">
  ...
  <div class="form-group">
  	<input type="datetime-local" 
       name="mtime" class="form-control" 
       min="2008-06-07T00:00">
  </div>
  
  <button type="submit" name="cc" class="btn btn-default">update date</button>
</form>
