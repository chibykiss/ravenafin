...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="hero-1-content wow fadeInLeft animated">
                        <h5 class="cate  wow fadeInUp animated" data-wow-delay="0.2s">Go from monetary pressure to monetary yes</h5>
                        <h1 class="title  wow fadeInUp animated" data-wow-delay="0.4s"> Fastest way to Transfer Money 
                        </h1>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.6s">
                        Get reliable help with your credict card 
                            processing needs
                        </p>
                        <div class="hero-1-button-group">
                            <a href="login.php" class="btn theme-btn-1  wow fadeInUp animated" data-wow-delay="0.8s"> Get
                                Started
                ...
                <div class="row m-0">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <p>We innovate systematically with three Partners contribute their experience and skill.</p>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <p>for over 20 years as a bank-like financial company, Ichartered was granted an authorised securities dealer license in 1999 and then a banking license in 2010</p>
                            <a href="features-1.html" class="read-more-btn">Read More</a>
                        </div>
                    </div>
                    <!-- /col -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <h3>Live Support</h3>
                            <p>We offer good customer service system with a customer form and a 24/7 livechat system</p>
                            <a href="features-1.html" class="read-more-btn">Read More</a>
                        </div>
                    </div>
                    <!-- /col -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <p>We place customers at the center of everything we do. We want to exceed customer expectations and build relationships that last a lifetime.</p>
                            <!-- <a href="features-1.html" class="read-more-btn">Read More</a> -->
                        </div>
                    </div>
                    <!-- /col -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-content warp">
                        ...
                        <!-- /row -->
                        <strong> We are Ravennafin, We have been providing banking solutions for over 30 years.</strong>
                             <p>We are the most preferred, trustworthy, leading bank in America because we provide rapid, 
                                 efficient and top quality banking solutions to meet the needs of customers and consistently 
                                 enhance shareholder's value.</p>
                                 <p>We believe value is created for our customers by having true, quality, in-person service 
                                     focused on solutions that make life easier for them.</p>
    ...
    <!-- /Services -->
    <div id="service_area" class="services-area">
        <!-- Container -->
        <div class="container">
            <!-- row -->
            <div class="row justify-content-center text-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>With several checking accounts to choose from.</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>We offer a wide range of collection and payment</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>We give loans for education, business or personal</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>with our mobile services u can bank</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>Our instant issue debits and credit cards makes accessing your cash quick.</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services-item">
                        ...
                        <div class="content">
                            ...
                            <span>You can transfer locally or intenational</span>
                        </div>
                    </div>
                </div>
                <!-- /col -->
                    ...
                    <div class="testimonial-item-wrap-1 testimonial-carousel-1">
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-desc">
                                ...
                                My experience with Ravennafin has been very accommodating for they have online banking. 
                                </p>
                            </div>
                        </div>
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-desc">
                                <p class="testimonial__desc">
                                They expect speedy and free delivery of these services because Apex Growth Bank has made it an easy task. 
                                </p>
                            </div>
                        </div>
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-desc">
                                <p class="testimonial__desc">
                                When I need to transfer funds and pay bills it can be the easiest task of my life
                                </p>
                            </div>
                        </div>
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-desc">
                                <p class="testimonial__desc">
                                Customers now expect to move seamlessly between digital and physical channels.  
                                </p>
                            </div>
                        </div>
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-desc">
                                <p class="testimonial__desc">
                                Transfering through webister trust is seamlss, fast and efficient
                                </p>
                            </div>
                        </div>
                        <!-- <div class="testimonial-item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="why-choose-us-content mb-removed">
                        ...
                        <!-- /row -->
                        <p>there are reasons why we are the best choice for your banking. and some includes</p>
                        <ul>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Transparent</h3>
                                <p>We offer a fawless and transparent service. from our loans and online banking services. you can contact us anything if anything soes not go fine.</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Proactive</h3>
                                <p>We offer a quick and proactive approach to banking. our services are fast and efficient.</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Affordable</h3>
                                <p>We have affordable plans. our loan plans have very flexible interest rates. also our fees on transaction are pocket friendly</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Secure</h3>
                                <p> Doing transcation with us is safe and secure. you dont have to worry about cyber attacks or viruses. we have cyber engineers that makes sure that your transactions are safe and secure.</p>
                            </li>
                        </ul>
                    </div>
                </div>
